...
import ImgDN1 from 'assets/image/imageDoiNgu1.png';
  ...
  render() {
    ...
    return (
      <div style={{ ...styles, backgroundColor: 'white', width: '100%' }}>
        ...
        >
          <h5 style={{ fontSize: 22, margin: 0, marginBottom: 12, color: 'black', height: 84, overflow: 'hidden' }}>
