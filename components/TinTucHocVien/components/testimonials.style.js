...
const TestimonialSecWrapperTT = styled.section`
  padding: 80px 0;
...
export const TestimonialItemTT = styled.div`
...
export const ImageWrapperTT = styled.div`
  width: 50px;
  height: 50px;
  flex-basis: 50px;
  display: block;
...
export default TestimonialSecWrapperTT;
