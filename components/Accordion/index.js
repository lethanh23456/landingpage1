...
import {
  AccordionBodyWrapper, AccordionItemButtonWrapper, AccordionItemWrapper,
  AccordionTitleWrapper, AccordionWrapper,
...
const Accordion = ({ className, children, allowZeroExpanded = true }) => {
  ...
  return (
    <AccordionWrapper allowZeroExpanded={allowZeroExpanded} className={addAllClasses.join(' ')}>
      {children}
    </AccordionWrapper>
  );
};
