          ...
          <Row gutter={[12, 10]} >
            ...
            <Col xs={24} md={24} lg={4}>
              <Form.Item label="Ngày Sinh">
                {getFieldDecorator('ngaySinh', {
                  // initialValue: model.edit ? _.get(model.record, 'maSv', '') : '',
                })(<DatePicker placeholder="VD: 12/04/1999" format="DD/MM/YYYY" />)}
              </Form.Item>
            </Col>
            ...
            <Col xs={24} sm={24} md={24} lg={10}>
              <Form.Item label="Số hiệu VB">
                ...
                })(<Input style={{ maxWidth: 500 }} placeholder="Số hiệu văn bằng" />)}
              </Form.Item>
            </Col>
          </Row>
          <Row>
            <p><i>Lưu ý: chỉ nhập họ tên và ngày tháng năm sinh hoặc nhập số hiệu Văn bằng để tra cứu </i></p>
          </Row>
          <Form.Item
            wrapperCol={{
              xs: { span: 24, offset: 0 },
