  ...
  return (
    <>
      {/* <NextSeo
        title={tieuDe}
        description={moTa}
        canonical="https://tuyensinhptit.aisenote.com/"
        openGraph={{
          url: `https://tuyensinhptit.aisenote.com/tintuc/${slug}`,
          title: tieuDe,
          description: moTa,
          images: [
            {
          ...
          site_name: 'Tuyển sinh Học viện Công nghệ Bưu chính viễn thông',
        }}
        twitter={{
          handle: '@handle',
          site: '@site',
