		...
		<Box style={{ marginTop: 120 }}>
			<TinTucWrapper>
				<Container>
					...
					<Row>
					<p style={{
 marginTop: '60', fontSize: '30px', textAlign: 'center', color: '#D13E32', margin: '0 0 10px',
}}
					>
                HỌC VIỆN CÔNG NGHỆ BƯU CHÍNH VIỄN THÔNG
     </p>
              <p style={{
 color: '#1E1E1E', fontSize: '26px', textAlign: 'center', margin: '0 0 10px',
}}
              >
PHÒNG ĐÀO TẠO
              </p>
			  <TitleUnderWrapper />
					...
					<Row type="flex" justify="center" gutter={[20, 20]} style={{ marginTop: 20 }}>
						{relate.map((item, index) => {
							if (item.chucVu !== 'Trưởng phòng') {
								return (
									<Col
