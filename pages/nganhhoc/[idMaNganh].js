...
import Navbar from "components/NavbarNganhHoc/index";
...
const dataBreadCrumb = [
  ...
  // { name: 'Ngành công nghệ thông tin', url: '#' },
];
...
const NganhHoc = ({ dataFetch, params }) => {
  ...
  const tenChuyenNganh = _.get(data[0], "tenChuyenNganh", []);
